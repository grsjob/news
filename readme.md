...
Источники новостей настраиваются в файле [`src/index.ts`](src/index.ts:63-84) при инициализации Core:
...
Обработка статей через языковую модель настраивается в файле [`src/index.ts`](src/index.ts:52-62):
...
Уведомления настраиваются в файле [`src/index.ts`](src/index.ts:85-105):
...
Расписание можно изменить в файле [`src/index.ts`](src/index.ts:117-120):
